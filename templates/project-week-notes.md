...
# {{PROJECT_NAME}} — Project Notes — {{WEEK}}

Private working memory for this Project and week. Daily appends complete,
source-linked observations under the matching section. Existing note blocks are
never edited or deleted. Weekly freezes all Projects together before producing
reports or persistent entity updates.
