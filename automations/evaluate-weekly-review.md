...
Load `evals/weekly-review-evals.json`,
`evals/seed/kamdar-company-os.seed.json`,
`automations/schemas/weekly-review-result.zod.mjs`,
...
- [ ] **1 — Freeze and validate the one Weekly run.**
  ...
  The immutable W34 fixture files under `automations/examples/golden/` are the
