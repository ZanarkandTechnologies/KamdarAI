...
4. Write `seed/reviews/realism.json` using `evals/schemas/seed-realism-review.zod.mjs`. The review must bind the exact seed ID and SHA-256. Do not edit the seed while reviewing it.
