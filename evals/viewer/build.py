...
metrics.innerHTML=metricData.map(([tone,label])=>'<span class="metric-pill"><i class="square metric-square tone-'+tone+'"></i>'+esc(label)+'</span>').join('')+'<span class="metric-pill"><i class="square metric-square tone-yellow"></i>'+esc(String(model.runStatus).replaceAll('_',' '))+'</span><a class="run-link" href="activity.jsonl">log ↗</a><a class="run-link" href="doctor-receipt.json">receipt ↗</a>';
